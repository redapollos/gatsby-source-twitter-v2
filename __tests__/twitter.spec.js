...
const bearer =
    "AAAAAAAAAAAAAAAAAAAAAJx9nwEAAAAAeGnx8cHJMyBYUeu7hG2ubDbEe40%3DACCGdu7YJ8LWH7zfkakbUAL4dkXcbu05AkN4GANTmJVu7MGDgJ"
...
describe.only(`Twitter`, () => {
    ...
    test(`Should use params`, async () => {
        ...
        var mockClient = new TwitterApi(bearer)
